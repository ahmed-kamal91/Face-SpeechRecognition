...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_HANDLE', 'Font', 'IFontEventsDisp', 'OLE_CANCELBOOL',
           'Gray', 'Color', 'OLE_YSIZE_HIMETRIC', 'VgaColor',
           'FONTBOLD', 'FONTNAME', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_CONTAINER', 'OLE_OPTEXCLUSIVE', 'IPicture',
           'OLE_XPOS_CONTAINER', 'Unchecked', 'FontEvents', 'IFont',
           'Picture', 'OLE_XSIZE_PIXELS', 'FONTITALIC',
           'OLE_XPOS_HIMETRIC', 'IPictureDisp', 'StdPicture',
           'OLE_XPOS_PIXELS', 'FONTSTRIKETHROUGH', 'OLE_TRISTATE',
           'OLE_YSIZE_PIXELS', 'Checked', 'Default', 'StdFont',
           'FONTSIZE', 'OLE_YPOS_HIMETRIC', 'FONTUNDERSCORE',
           'LoadPictureConstants', 'OLE_XSIZE_CONTAINER', 'OLE_COLOR',
           'IFontDisp', 'OLE_YPOS_PIXELS', 'Monochrome']
